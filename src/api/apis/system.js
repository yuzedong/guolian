...
export default {
  ...
  fetchOrganizeListTreeNoauth (data) {
    return axios.get(systemUrls.organizeListTreeNoauth, data)
  },
  fetchOrganizeCount (data) {
    return axios.get(systemUrls.organizeCount, data)
  },
  ...
  fetchOrganizeDelete (data) {
    return axios.delete(systemUrls.organize + '/delete', data)
  },
  fetchOrganizeGet ({ id }) {
  ...
  fetchOrganizeListUsersDelete (data) {
    return axios.delete(systemUrls.organizeListUsers + '/delete', data)
  },
  ...
  fetchSystemRoleDelete (data) {
    return axios.delete(systemUrls.sysRoles + '/delete', data)
  },
  ...
  fetchUserSecretDelete (ids) {
    return axios.delete(systemUrls.userSecret + '/delete', { ids })
  },
  ...
  fetchSysSecretDelete (data) {
    return axios.delete(systemUrls.sysSecrets + '/delete', data)
  },
  ...
  fetchSysSecretsContentAll (data) {
    return axios.get(systemUrls.sysSecretsContentAll, data)
  },
  // 用户列表
  ...
  fetchSysUsersDelete (data) {
    return axios.delete(systemUrls.sysUsers + '/delete', data)
  },
  ...
  fetchRolesListUsersDelete (data) {
    return axios.delete(systemUrls.sysRolesListUsers + '/delete', data)
  },
  // 角色成员管理-添加
  ...
  // API-删除
  fetchApisDelete (ids) {
    return axios.delete(systemUrls.apis + '/delete', { ids })
  },
  // API-修改
  ...
  fetchMenusDelete (ids) {
    return axios.delete(systemUrls.menus + '/delete', { ids })
  },
  // 菜单-修改
  ...
  fetchFtpStorageDelete (ids) {
    return axios.delete(systemUrls.ftpStorage + '/delete', { ids })
  },
  // FTP修改信息
  ...
  fetchModelDelete (ids) {
    return axios.delete(systemUrls.model + '/delete', { ids })
  },
  // 模型-详情
  ...
  fetchOsspStorageDelete (ids) {
    return axios.delete(systemUrls.ossStorage + '/delete', { ids })
  },
  // 云存储修改信息
  ...
  resourceSpaceDelete (data) {
    return axios.delete(systemUrls.resourceSpaces + '/delete', data)
  },
  // 资源空间-移动
  ...
  resourceSpaceDatasDelete (data) {
    return axios.delete(systemUrls.resourceSpaceDatas + '/delete', data)
  },
  // 资源-详情
  ...
  fetchSystemAreaDelete (data) {
    return axios.delete(systemUrls.systemArea + '/delete', data)
  },
  // 校验区域编号
  ...
  fetchSystemDatabaseBackupDelete (data) {
    return axios.delete(systemUrls.systemDatabaseBackup + `/delete/${data.id}`)
  },
  // 备份列表
  ...
  fetchPfruleDelete (data) {
    return axios.delete(systemUrls.pfrule + '/delete', data)
  },
  // 绩效管理-保存
  ...
  fetchPfscoreDetele (data) {
    return axios.delete(systemUrls.pfscore + '/delete', data)
  },
  // 绩效管理-开始评分
  ...
  // sms模板详情
  fetchSystemSmsTempDetails (data) {
    return axios.get(systemUrls.smsTemplateDetail + `/${data.id}`)
  },
  // sms模板列表
  fetchSmsTplListPage () {
    return axios.get(systemUrls.smsTemplateList)
  },
  // sms模板更新
  fetchSmsTplUpdate (data) {
    return axios.post(systemUrls.smsTemplateDetailUpdate, data)
  },
  /* global-weak-pwd start */
  // 弱密码检测
  fetchUsersGetCipherWeak (data) {
    return axios.get(systemUrls.usersGetCipherWeak, data)
  }
  /* global-weak-pwd end */
