...
export default {
  ...
  fetchMembersGroupDelete (data) {
    return axios.delete(vipUrls.membersGroup + '/delete', data)
  },
  // 会员等级列表信息
  ...
  fetchMemberLevelDelete (data) {
    return axios.delete(vipUrls.memberLevel + '/delete', data)
  },
  // 会员管理列表
  ...
  fetchMembersDelete (data) {
    return axios.delete(vipUrls.membersList + '/delete', data)
  },
  // 会员新增
