...
export default {
  ...
  wechatInfoRevoke (data) {
    return axios.delete(wechat.wechatInfo + '/delete', data)
  },
  // 获取公众号，小程序详情
  wechatInfoGet (data) {
  ...
  miniprogramversionRecordDelete (data) {
    return axios.delete(wechat.miniprogramversionAudit + '/delete', data)
  },
  // 获取线上版本
  ...
  miniprogrammemberDelete (data) {
    return axios.delete(wechat.miniprogrammember + '/delete', data)
  },
  // 服务器列表-小程序
  ...
  fetchWechatmenugroupDelete (data) {
    return axios.delete(wechat.wechatmenugroup + '/delete', data)
  },
  // 菜单-生效
  ...
  fetchWechatMaterialDelete (data) {
    return axios.delete(wechat.wechatMaterial + '/delete', data)
  },
  // 素材-新增图文素材
  ...
  fetchWechatreplycontentDelete (data) {
    return axios.delete(wechat.wechatreplycontent + '/delete', data)
  },
  // 查询自动回复
  ...
  fetchWwechatreplyclickDelete (data) {
    return axios.delete(wechat.wechatreplyclick + '/delete', data)
  },
  // 小程序代码管理分页
  ...
  fetchWechatMiniprogramCodeTemplateDelete (data) {
    return axios.delete(wechat.wechatMiniprogramCodeTemplate + '/delete', data)
  },
  // 小程序代码管理设置最新模板
  ...
  fetchWechattagsDelete (data) {
    return axios.delete(wechat.wechattags + '/delete', data)
  },
  // 查标签是否存在
  ...
  fetchWechatsendDelete (data) {
    return axios.delete(wechat.wechatsend + '/delete', data)
  },
  // 推送汇总
  ...
  fetchWechatcommentReplyDelete (data) {
    return axios.delete(wechat.wechatcommentReply + '/delete', data)
  },
  // 同步粉丝黑名单
  ...
  fetchWechatcommentDelete (data) {
    return axios.delete(wechat.wechatcomment + '/delete', data)
  },
  // 内容栏目树
