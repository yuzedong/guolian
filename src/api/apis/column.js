...
export default {
  ...
  // 校验栏目名称或路径
  fetchChannelCountPathPrefix (data) {
    return axios.get(columnUrls.channelCountPathPrefix, data)
  },
  ...
  fetchChannelDelete (data) {
    return axios.delete(columnUrls.channel + '/delete', data)
  },
  // 彻底删除
  fetchChannelThorough (data) {
    return axios.delete(columnUrls.channelThorough + '/delete', data)
  },
  // 还原
