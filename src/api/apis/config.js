...
export default {
  ...
  fetchTemplateDelete (data) {
    return axios.delete(configUrls.template + '/delete', data)
  },
  // 模板管理获取模板信息
  ...
  fetchResourceDelete (data) {
    return axios.delete(configUrls.resource + '/delete', data)
  },
  // 文件管理查询资源
  ...
  fetchSitesDelete (data) {
    return axios.delete(configUrls.sites + '/delete', data)
  },
  // 站点管理验证域名
  ...
  fetchSitesRecycleDelete (data) {
    return axios.delete(configUrls.sitesRecycle + '/delete', data)
  },
  // 站点管理站点模板列表
  ...
  fetchstaticPageIndexDelete (data) {
    return axios.delete(configUrls.staticPageIndex + '/delete', data)
  },
  // 站点管理发布静态页发布栏目
  ...
  fetchstaticChannel (data) {
    return axios.delete(configUrls.sitesChannel + '/delete', data)
  },
  // 站点管理发布静态页发布内容
  ...
  fetchsitesContent (data) {
    return axios.delete(configUrls.sitesContent + '/delete', data)
  },
  // 站点管理开启站点
  fetchsitesOn (data) {
  ...
  fetchSensitiveWordsDelete (data) {
    return axios.delete(configUrls.sensitiveWords + '/delete', data)
  },
  // 敏感词-详情
  fetchSensitiveWordsGet (data) {
    return axios.get(configUrls.sensitiveWords + `/${data.id}`)
  },
  // 敏感词-重名验证
  ...
  fetchSysSearchWordsDelete (data) {
    return axios.delete(configUrls.sysSearchWords + '/delete', data)
  },
  // 搜索词-删除
  ...
  fetchHotWordCategorysDelete (data) {
    return axios.delete(configUrls.hotWordCategorys + '/delete', data)
  },
  // 热词-重名
  ...
  fetchHotWordsDelete (data) {
    return axios.delete(configUrls.hotWords + '/delete', data)
  },
  // 定时任务-列表数据
  fetchjobsList (data) {
  ...
  fetchjobsDelete (data) {
    return axios.delete(configUrls.jobs + '/delete', data)
  },
  // 定时任务-状态取消
  ...
  fetchContentTypeDelete (data) {
    return axios.delete(configUrls.contentType + '/delete', data)
  },
  // 内容类型-重名
  ...
  fetchContentMarksAgencyDelete (data) {
    return axios.delete(configUrls.contentMarksAgency + '/delete', data)
  },
  // 发文字号-机关代字-排序
  ...
  fetchContentMarksYearDelete (data) {
    return axios.delete(configUrls.contentMarksYear + '/delete', data)
  },
  // 发文字号-年号-排序
  ...
  fetchContentTagsDelete (data) {
    return axios.delete(configUrls.contentTags + '/delete', data)
  },
  // tag-重名
  ...
  fetchSysSourceDelete (data) {
    return axios.delete(configUrls.sysSource + '/delete', data)
  },
  // 来源管理-重名
  ...
  fetchFlowDelete (data) {
    return axios.delete(configUrls.flow + '/delete', data)
  },
  // 工作流检查
  fetchFlowCheck (data) {
  ...
  fetchAuditStrategy (data) {
    return axios.delete(configUrls.auditStrategy + '/delete', data)
  },
  // 审核策略管理-创建
  ...
  fetchAuditchannelset (data) {
    return axios.delete(configUrls.auditchannelset + '/delete', data)
  },
  // 审核栏目设置-选择栏目详情
  ...
  fetchAuditmodelset (data) {
    return axios.delete(configUrls.auditmodelset + '/delete', data)
  },
  // 审核模型设置-模型设置获取详情
