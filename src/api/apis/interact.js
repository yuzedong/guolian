...
export default {
  ...
  fetchInteractUsercommentDelete (data) {
    return axios.delete(interactUrls.interactUsercomment + '/delete', data)
  },
  // 评论管理新增禁止
  ...
  fetchSysblacklistDelete (data) {
    return axios.delete(interactUrls.sysblacklist + '/delete', data)
  },
  ...
  fetchUsercommentReportDelete (data) {
    return axios.delete(interactUrls.usercommentReport + '/delete', data)
  },
  ...
  fetchLinkTypesDelete (data) {
    return axios.delete(interactUrls.linkTypes + '/delete', data)
  },
  // 检验类别名称是否唯一
  ...
  fetchlinksDelete (data) {
    return axios.delete(interactUrls.links + '/delete', data)
  },
  // 友情链接启用
  ...
  fetchQuestionnaireDelete (data) {
    return axios.delete(interactUrls.questionnaire + '/delete', data)
  },
  // 投票调查-发布
  ...
  fetchQuestionnaireAnswerDelete (data) {
    return axios.delete(interactUrls.questionnaireAnswer + '/delete', data)
  },
  // 投票调查-统计-按用户-查看
  ...
  fetchsmartFormTypeDelete (data) {
    return axios.delete(interactUrls.smartFormType + '/delete', data)
  },
  // 智能表单-表单列表
  ...
  fetchSmartFormListDelete (data) {
    return axios.delete(interactUrls.smartFormDataDetail + '/delete', data)
  },
  // 智能表单-统计-图表
  ...
  fetchSmartFormDelete (data) {
    return axios.delete(interactUrls.smartForm + '/delete', data)
  },
  // 智能表单-字段编辑
  ...
  fetchMailboxFormDelete (data) {
    return axios.delete(`${interactUrls.mailboxForm}/delete`, data)
  },
  // 表单复制
  ...
  fetchMailboxLetterTypeDelete (data) {
    return axios.delete(`${interactUrls.mailboxLetterType}/delete`, data)
  },
  // 信箱类型列表
  ...
  fetchMailboxLetterBoxTypeDelete (data) {
    return axios.delete(`${interactUrls.mailboxLetterBoxType}/delete`, data)
  },
  // 信箱分页
  ...
  fetchMailboxLetterBoxDelete (data) {
    return axios.delete(`${interactUrls.mailboxLetterBox}/delete`, data)
  },
  // 信件分页
