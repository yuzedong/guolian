...
export default {
  ...
  fetchContentextDelete (data) {
    return axios.delete(contentUrls.contentext + '/delete', data)
  },
  // 还原内容
  ...
  fetchContentVersionDelete (data) {
    return axios.delete(contentUrls.contentVersion + '/delete', data)
  },
  // 版本-查询
  ...
  fetchContentrelationDelete (data) {
    return axios.delete(contentUrls.contentrelation + '/delete', data)
  },
  // 相关内容-排序
