...
export default {
  ...
  created () {
    ...
    window.localStorage.setItem('baseNeditor', `${process.env.VUE_APP_API_HOST}/cmsmanager`)
    /* system-cms-prefix change
    window.localStorage.setItem('baseNeditor', `${process.env.VUE_APP_API_HOST}/cmsadmin`)
    system-cms-prefix change */
