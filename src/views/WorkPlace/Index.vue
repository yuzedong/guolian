<template>
  <section class="workplace-container scrollbar">
    ...
    <section class="big-box bottom-box">
      <div class="left-box box topchart">
        <div class="title">
          <span>趋势图</span>
        ...
        <div class="select">
          <el-radio-group v-model="showType">
            <el-radio class="bugXiugai" :label="1">浏览量(PV)</el-radio>
            <el-radio class="bugXiugai" :label="2">访客数(UV)</el-radio>
            <el-radio class="bugXiugai" :label="3">IP数</el-radio>
            <el-radio class="bugXiugai" :label="4">跳出率</el-radio>
            <el-radio class="bugXiugai" :label="5">平均访问时长</el-radio>
          </el-radio-group>
        </div>
        <tendency :tendencyFields='tendencyFields' :tendencyData='finallyData' ></tendency>
      </div>
      <div class="right-box box secondchart">
        <div class="title">
          <span>新老访客</span>
