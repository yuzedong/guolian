      ...
      <div class="wx-msg-content">
        <div class="wx-msg-content__inner">
          <el-input type="text" class="wx-content__title"
            v-model="articleObj.title" :readonly="!edit" @blur="infoChange"
        ...
        <div class="wx-msg-content__inner">
          <el-input type="text" class="wx-content__author"
            v-model="articleObj.author" :readonly="!edit" @blur="infoChange"
            placeholder="请输入作者" maxlength="8"></el-input>
          <label class="wx-content__label">{{articleObj.author.length || 0}}/8</label>
        </div>
         <div class="wx-msg-content__inner">
          <el-input type="text" class="wx-content__author" @blur="infoChange"
...
export default {
  ...
  watch: {
    ...
    'articleObj.content' (newVal, oldVal) {
      this.infoChange()
    }
  },
  methods: {
