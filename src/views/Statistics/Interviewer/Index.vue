  ...
  methods: {
    ...
    handleSearchs () {
      ...
      if (this.params.time2) {
        ...
        this.params.time[0] = this.$moment(this.params.beginTime, 'YYYY-MM-DD HH:mm:ss', true)
        this.params.time[1] = this.$moment(this.params.endTime, 'YYYY-MM-DD HH:mm:ss', true)
