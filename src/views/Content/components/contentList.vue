...
export default {
  ...
  methods: {
    ...
    handleEventAdd (btn) {
    //   console.log(btn)
      this.$routerLink('/content/create', 'add', { modelId: btn.id, id: '', modelName: btn.text, channelId: this.id || '' })
    ...
    handleCommandAdd (id) {
      ...
      console.log(model)
      this.$routerLink('/content/create', 'add', { modelId: id, modelName: model.label || '', channelId: this.id || '' })
    },
    setHeaderBth (data) {
