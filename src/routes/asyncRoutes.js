...
export default [
  // 工作台
  {
    ...
    'children': [
      ...
      },
      {
        ...
        'name': 'workplaceMailbox',
        'hidden': true
      },
      {
        'path': '/workplace/mailbox/detail',
        'name': 'workplaceMailboxDetail',
        'hidden': true
      }
    ]
  },
  ...
  // 配置
  {
    ...
    'children': [
      ...
      // 内容付费
      {
        'path': '/config/content-pay',
        'name': 'configContentPay',
        'children': [
          {
            'path': '/config/content-pay/pay-config/index',
            'name': 'configPayConfigIndex'
          },
          {
            'path': '/config/content-pay/pay-statistics',
            'name': 'configPayStatistics',
            'children': [
              {
                'path': '/config/content-pay/pay-statistics/index',
                'name': 'configPayStatisticsIndex'
              },
              {
                'path': '/config/content-pay/pay-statistics/detail',
                'name': 'configPayStatisticsDetail'
              }
            ]
          },
          {
            'path': '/config/content-pay/user-statistics',
            'name': 'configUserStatistics',
            'children': [
              {
                'path': '/config/content-pay/user-statistics/index',
                'name': 'configUserStatisticsIndex'
              },
              {
                'path': '/config/content-pay/user-statistics/detail',
                'name': 'configUserStatisticsDetail'
              },
              {
                'path': '/config/content-pay/user-statistics/withdrawdetail',
                'name': 'configUserStatisticsWithdrawdetail'
              }
            ]
          },
          {
            'path': '/config/content-pay/pay-detail',
            'name': 'configPayDetail',
            'children': [
              {
                'path': '/config/content-pay/pay-detail/index',
                'name': 'configPayDetailIndex'
              },
              {
                'path': '/config/content-pay/pay-detail/detail',
                'name': 'configPayDetailDetail'
              }
            ]
          },
          {
            'path': '/config/content-pay/cash-management/index',
            'name': 'configCashManagement'
          }
        ]
      }
    ]
  ...
  // 互动
  {
    ...
    'children': [
      ...
      // 领导信箱
      {
        'path': '/interact/mailbox',
        'name': 'interactMailbox',
        'children': [
          // 表单列表
          {
            'path': '/interact/mailbox/form',
            'name': 'interactMailboxForm',
            'children': [
              {
                'path': '/interact/mailbox/form/index',
                'name': 'interactMailboxFormIndex',
                'hidden': true
              },
              {
                'path': '/interact/mailbox/form/detail',
                'name': 'interactMailboxFormDetail',
                'hidden': true
              },
              {
                'path': '/interact/mailbox/form/view',
                'name': 'interactMailboxFormView',
                'hidden': true
              }
            ]
          },
          // 信件类型管理
          {
            'path': '/interact/mailbox/types',
            'name': 'interactMailboxTypes',
            'children': [
              {
                'path': '/interact/mailbox/types/index',
                'name': 'interactMailboxTypesIndex',
                'hidden': true
              },
              {
                'path': '/interact/mailbox/types/detail',
                'name': 'interactMailboxTypesDetail',
                'hidden': true
              },
              {
                'path': '/interact/mailbox/types/create',
                'name': 'interactMailboxTypesCreate',
                'hidden': true
              }
            ]
          },
          // 信箱管理
          {
            'path': '/interact/mailbox/manage',
            'name': 'interactMailboxManage',
            'children': [
              {
                'path': '/interact/mailbox/manage/index',
                'name': 'interactMailboxManageIndex',
                'hidden': true
              }
            ]
          },
          // 我的信箱
          {
            'path': '/interact/mailbox/my',
            'name': 'interactMailboxMy',
            'children': [
              {
                'path': '/interact/mailbox/my/index',
                'name': 'interactMailboxMyIndex',
                'hidden': true
              },
              {
                'path': '/interact/mailbox/my/detail',
                'name': 'interactMailboxMyDetail',
                'hidden': true
              }
            ]
          },
          // 信件统计
          {
            'path': '/interact/mailbox/statistics',
            'name': 'interactMailboxStatistics',
            'children': [
              {
                'path': '/interact/mailbox/statistics/index',
                'name': 'interactMailboxStatisticsIndex',
                'hidden': true
              }
            ]
          },
          // 统计报表
          {
            'path': '/interact/mailbox/report',
            'name': 'interactMailboxReport',
            'children': [
              {
                'path': '/interact/mailbox/report/index',
                'name': 'interactMailboxReportIndex',
                'hidden': true
              },
              {
                'path': '/interact/mailbox/report/detail',
                'name': 'interactMailboxReportDetail',
                'hidden': true
              }
            ]
          }
    ...
    'children': [
      ...
      // 模型管理
      {
        ...
        'children': [
          ...
          // 发文机关管理
          {
            'path': '/system/model/issuing/authority',
            'name': 'issuingAuthorityIndex'
          },
          // 主题分类管理
          {
            'path': '/system/model/topiccate',
            'name': 'topicCateIndex'
          },
          // 来源管理
          {
