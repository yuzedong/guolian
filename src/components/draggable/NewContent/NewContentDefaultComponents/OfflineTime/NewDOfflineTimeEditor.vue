<script>
import compoment from '@/components/draggable/NewContent/NewCustomComponents/DateTime/NewDDateTimeEditor'
export default {
  name: 'NewDOfflineTimeEditor',
  extends: compoment,
  data () {
    const formatOptions = {
    ...
    return {
      formItems: [
        ...
        },
        {
          prop: 'isDefaultNow',
          label: '默认日期时间：',
          itemClass: 'margin-bottom15 width',
          type: 'checkbox',
          options: [
            {
              value: true,
