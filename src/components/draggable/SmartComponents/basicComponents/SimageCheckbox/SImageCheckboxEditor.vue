<template>
  <base-form
    class="s-image-radio-editor-containers s-draggable-editor"
    ref="baseForm"
              ...
              <div class="option-item new-cont-option flex" :key="index" >
                <el-checkbox :label="option.value">
                  <div class="option-radio option-radio-gender">
                    <el-input class="option-radio-input" v-model="scope.form.options[index].label" size="medium" :maxlength="50"></el-input>
                  </div>
                </el-checkbox>
                <div class="option-radio-icon flex">
                  <jee-icon iconClass="jia1" class="jee-hover-fill option-radio-icons"  @click="handleAddOption(index)"></jee-icon>
                  <jee-icon iconClass="jianqu" class="jee-hover-fill option-radio-icons"
                    v-show="scope.form.options.length>1"
                    @click="()=>handleDelOption(index)"></jee-icon>
...
import imageUpload from './../SImageRadio/imageUpload'
export default {
  name: 'SImageCheckboxEditor',
  components: {
    imageUpload
  },
...
<style lang="scss">
  .s-image-radio-editor-containers.s-draggable-editor{
