            ...
            <div v-if="hiddenFn(item,form)" class="form-item-wrap">
              ...
              >
                <el-radio-group v-model="form[item.prop]">
                  ...
                  <jee-popover style="margin-left:8px" v-if="option.popoverText" v-bind="option" :popoverWidth="option.popoverWidth" /></el-radio>
                </el-radio-group>
              ...
              >
                <el-input type="textarea"
                  ...
                  :placeholder="item.placeholder"
                  :show-word-limit="item.showWordLimit?item.showWordLimit:''"></el-input>
                  <div v-if="item.explain" class="gray">{{item.explain}}</div>
              </el-form-item>
              <!-- 密码输入框 -->
              <el-form-item
              ...
              >
                ...
                <div v-if="item.explain" class="gray">{{item.explain}}</div>
                <jee-popover style="margin-left:8px" v-if="item.popoverText" v-bind="item" :popoverWidth="item.popoverWidth" />
              </el-form-item>
              <!-- 选择上传 -->
              <el-form-item
                :key="index"
