...
(function () {
  /**
     ...
     */
  var URL = './NEditor/' || window.UEDITOR_HOME_URL || getUEBasePath()
  ...
  window.UEDITOR_CONFIG = {
    ...
    theme: 'notadd', //, themePath:URL +"themes/"
    ...
    whitList: {
      ...
      source: ['src', 'type'],
      embed: ['flashvars', 'type', 'class', 'pluginspage', 'src', 'width', 'height', 'align', 'style', 'wmode', 'play', 'autoplay', 'loop', 'menu', 'allowscriptaccess', 'allowfullscreen', 'controls', 'preload'],
